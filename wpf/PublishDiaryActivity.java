...
public class PublishDiaryActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		btnDiary.setOnClickListener(new View.OnClickListener()
		{
			...
			{
				pd = ProgressDialog.show(PublishDiaryActivity.this, "请稍候",
						"正在发布日志...", true, true);
				publishDiary(); // 发表日志
			}
		});
		...
		btnDiaryBack.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				Intent intent = new Intent(PublishDiaryActivity.this,
						FunctionTabActivity.class);// 创建Intent
				intent.putExtra("uno", uno); // 设置Intent的Extra字段
	...
	public void publishDiary()
	{
		new Thread()
		{
			public void run()
			{
				...
				{ // 如果标题或内容为空
					Toast.makeText(PublishDiaryActivity.this, "请将日记的标题或内容填写完整",
				...
				try
				{
					...
					String message = "<#NEW_DIARY#>" + title + "|" + diary
							+ "|" + uno;
