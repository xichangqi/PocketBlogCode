...
public class RegActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		btnReg.setOnClickListener(new View.OnClickListener()
		{
			...
			{
				pd = ProgressDialog.show(RegActivity.this, "请稍候...",
						"正在连接服务器...", false);
				register();
			}
		});
	...
	public void register()
	{
		new Thread()
		{
			public void run()
			{
				...
				{
					Toast.makeText(RegActivity.this, "请将注册信息填写完整",
				...
				try
				{
					...
					String regInfo = "<#REGISTER#>" + name + "|" + pwd1 + "|"
							+ email + "|" + status;
					...
					{ // 注册失败
						Toast.makeText(RegActivity.this, "注册失败！请重试！",
								Toast.LENGTH_LONG).show();
					}
				} catch (Exception e)
				{
