...
public class MyDiaryActivity extends Activity
{
	...
	BaseAdapter ba = new BaseAdapter()
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			btnEditDiary
					.setTextAppearance(MyDiaryActivity.this, R.style.button);
			btnEditDiary.setLayoutParams(new LinearLayout.LayoutParams(60,
			...
			btnDeleteDiary.setTextAppearance(MyDiaryActivity.this,
					R.style.button);
			btnDeleteDiary.setLayoutParams(new LinearLayout.LayoutParams(60,
					LayoutParams.WRAP_CONTENT));
		...
		new Thread()
		{
			public void run()
			{
				...
				try
				{
					...
					{ // 删除成功
						Toast.makeText(MyDiaryActivity.this, "删除日志成功！",
								Toast.LENGTH_LONG).show();
						getDiaryList();
						Looper.loop();
					} else
					{ // 删除失败
						Toast.makeText(MyDiaryActivity.this, "删除失败，请重试！",
								Toast.LENGTH_LONG).show();
						Looper.loop();
					}
