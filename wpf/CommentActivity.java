...
public class CommentActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		btnComment.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				if (content.equals(""))
				{ // 未输入评论内容
					Toast.makeText(CommentActivity.this, "请输入评论内容",
	...
	public void makeNewComment(String content, String rid, String uno)
	{
		try
		{
			...
			mc.dout.writeUTF("<#NEW_COMMENT#>" + content + "|" + rid + "|"
					+ uno);
			String reply = mc.din.readUTF(); // 读取回复
			if (reply.equals("<#NEW_COMMENT_SUCESS#>"))
			{ // 解析回复
				Toast.makeText(CommentActivity.this, "评论添加成功！",
						Toast.LENGTH_LONG).show();
			} else
			{
				Toast.makeText(CommentActivity.this, "评论添加失败！",
						Toast.LENGTH_LONG).show();
			}
		} catch (Exception e)
		{
