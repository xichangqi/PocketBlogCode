<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="GBK" import="java.util.*,com.blog.bean.User"%>
...
<%
	...
	if(uno != null){
		...
		User user = controler.getUser(uno);
%>
	<table>
		<tr>
			<td rowspan="2">
	...
	<iframe name="contentChild" width="100%" height="700px" scrolling="auto" frameborder="0">
