<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.blog.bean.User,com.blog.dao.*,java.util.*"%>
...
%>
		<form action="UserServlet" method="post" name="form1">
			<table	align="center" width="70%" height="100%" border="0">
				<tr >
		...
		<%if(result != null) {%>
			<p style="color:red; font-size: 20px"><%= result %></p> 
<%
		}
	}
	else{	//是注册后的信息返回界面

%>	注册成功，您的微博号码为：<p style="color:blue; font-size: 50px"><%= user.u_no %></p>
<%
} 
%>	
